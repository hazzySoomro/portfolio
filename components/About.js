      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 max-w-xl text-md tracking-widest text-gray-600">
            ...
            now spending my time building projects on MERN 'Mangoose Express
            React/Next.js Node.js' and learning new technologies.
          </p>
        </div>
        <div className="w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
          <Image src={AboutImg} className="rounded-xl w-full h-auto" alt="/" />
        </div>
      </div>
    </div>
  );
